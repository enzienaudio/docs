...
The Heavy C++ API is equivalent to the [C API](#08.c). Its usage is a matter of preference, but may make the organisation of systems with multiple context types and instances easier.
 ...
 */
bool bool setLengthForTable(unsigned int tableHash, unsigned int newSampleLength);
