...
int main(int argc, const char *argv[]) {
  ...
  for (int i = 0; i < numIterations; ++i) {
    hv_example_process_inline(context, NULL, outBuffers, blockSize);
    // do something with output here
  }
...
int main(int argc, const char *argv[]) {
  Hv_example *context = hv_example_new(0, 0, 44100.0);
 ...
 */
Hv_example *hv_example_new(double sampleRate);
 ...
 */
Hv_example *hv_example_new_with_options(double sampleRate, int poolKb, int queueKb);

/** Frees a patch instance. */
void hv_example_free(Hv_example *c);
 ...
 */
int hv_example_process(Hv_example *c,
 ...
 */
int hv_example_process_inline(Hv_example *c,
                            float *const inputBuffers,
                            float *const outputBuffers,
                            int n4);
 ...
 */
int hv_example_process_interleaved(Hv_example *c, float *inputBuffers, float *outputBuffers, int n4);
```
### Common
