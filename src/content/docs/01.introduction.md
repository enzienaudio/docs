...
However it's important to note that Pd is merely used as a front-end authoring interface, Heavy does not make use of any Pure Data code, and it is entirely unrelated to the embeddable Pd engine, [libpd](https://github.com/libpd/libpd).
